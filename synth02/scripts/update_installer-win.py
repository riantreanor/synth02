...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=synth02 Demo Installer\n"
      else:
        line="OutputBaseFilename=synth02 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the synth02 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the synth02 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=synth02 Demo installer\n"
     else:
       line="SetupWindowTitle=synth02 installer\n"
